function pošliposly() {
    ...
    basic.showNumber(7)
    ESP8266_IoT.setData("3EDHAXEIWOUZXRZ1", avg_prasnost, Environment.octopus_BME280(Environment.BME280_state.BME280_temperature_C), Environment.octopus_BME280(Environment.BME280_state.BME280_humidity), Environment.octopus_BME280(Environment.BME280_state.BME280_pressure), Environment.ReadLightIntensity(AnalogPin.P2))
    basic.showNumber(8)
